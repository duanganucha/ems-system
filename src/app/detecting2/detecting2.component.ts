...
@Component({
  selector: 'app-detecting2',
  templateUrl: './detecting2.component.html',
  styleUrls: ['./detecting2.component.scss']
})
export class Detecting2Component implements OnInit {
